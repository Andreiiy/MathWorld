...
public class Exercise4Activity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(Common.questionList.get(12).getFraction()) {
            ...
            String[] questionString = Common.questionList.get(12).getExercise().split("/");
            ...
            tvQuestion1.setText(Common.questionList.get(12).getExercise());
        }

        if(Common.questionList.get(13).getFraction()) {
            ...
            String[] questionString = Common.questionList.get(13).getExercise().split("/");
            ...
            tvQuestion2.setText(Common.questionList.get(13).getExercise());
        }

        if(Common.questionList.get(14).getFraction()) {
            ...
            String[] questionString = Common.questionList.get(14).getExercise().split("/");
            ...
            tvQuestion3.setText(Common.questionList.get(14).getExercise());
        }

        if(Common.questionList.get(15).getFraction()) {
            ...
            String[] questionString = Common.questionList.get(15).getExercise().split("/");
            ...
            tvQuestion4.setText(Common.questionList.get(15).getExercise());
        }
    ...
    public void onClick(View v) {
        if(v.getId()==R.id.bnext){
            ...
            if(Common.questionList.get(12).getFraction()) {
                ...
                checkAnswerFraction(Common.questionList.get(12), answer);
            }else{
                if(etAnswer1.getText().toString().equals(Common.questionList.get(12).getAnswerCorrect()))
            ...
            if(Common.questionList.get(13).getFraction()) {
                ...
                checkAnswerFraction(Common.questionList.get(13), answer);
            }else{
                if(etAnswer2.getText().toString().equals(Common.questionList.get(13).getAnswerCorrect()))
                    Common.right_answer_count++;
            }
            ...
            if(Common.questionList.get(14).getFraction()) {
                ...
                checkAnswerFraction(Common.questionList.get(14), answer);
            }else{
                if(etAnswer3.getText().toString().equals(Common.questionList.get(14).getAnswerCorrect()))
                    Common.right_answer_count++;
            }
            if(Common.questionList.get(15).getFraction()) {
                ...
                checkAnswerFraction(Common.questionList.get(15), answer);
            }else{
                if(etAnswer4.getText().toString().equals(Common.questionList.get(15).getAnswerCorrect()))
                    Common.right_answer_count++;
            }
