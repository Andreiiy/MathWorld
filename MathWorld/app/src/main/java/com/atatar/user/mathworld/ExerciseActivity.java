...
public class ExerciseActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(Common.questionList.get(0).getFraction()) {
            ...
            String[] questionString = Common.questionList.get(0).getExercise().split("/");
            ...
            tvQuestion1.setText(Common.questionList.get(0).getExercise());
        }

        if(Common.questionList.get(1).getFraction()) {
            ...
            String[] questionString = Common.questionList.get(1).getExercise().split("/");
            ...
            tvQuestion2.setText(Common.questionList.get(1).getExercise());
        }

        if(Common.questionList.get(2).getFraction()) {
            ...
            String[] questionString = Common.questionList.get(2).getExercise().split("/");
            ...
            tvQuestion3.setText(Common.questionList.get(2).getExercise());
        }

        if(Common.questionList.get(3).getFraction()) {
            ...
            String[] questionString = Common.questionList.get(3).getExercise().split("/");
            ...
            tvQuestion4.setText(Common.questionList.get(3).getExercise());
        }
    ...
    public void onClick(View v) {
        if(v.getId()==R.id.bnext){
            if (Common.right_answer_count > 0)
            ...
            if(Common.questionList.get(0).getFraction()) {
                ...
                checkAnswerFraction(Common.questionList.get(0), answer);
            }else{
                if(etAnswer1.getText().toString().equals(Common.questionList.get(0).getAnswerCorrect()))
            ...
            if(Common.questionList.get(1).getFraction()) {
               ...
               // if(integer.equals("")) integer="/";
                ...
                checkAnswerFraction(Common.questionList.get(1), answer);
            }else{
                if(etAnswer2.getText().toString().equals(Common.questionList.get(1).getAnswerCorrect()))
                    Common.right_answer_count++;
            }
            ...
            if(Common.questionList.get(2).getFraction()) {
                ...
                checkAnswerFraction(Common.questionList.get(2), answer);
            }else{
                if(etAnswer3.getText().toString().equals(Common.questionList.get(2).getAnswerCorrect()))
                    Common.right_answer_count++;
            }
            if(Common.questionList.get(3).getFraction()) {
                ...
                checkAnswerFraction(Common.questionList.get(3), answer);
            }else{
                if(etAnswer4.getText().toString().equals(Common.questionList.get(3).getAnswerCorrect()))
                    Common.right_answer_count++;
            }
