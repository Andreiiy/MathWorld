...
public class Exercise3Activity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(Common.questionList.get(8).getFraction()) {
            ...
            String[] questionString = Common.questionList.get(8).getExercise().split("/");
            ...
            tvQuestion1.setText(Common.questionList.get(8).getExercise());
        }

        if(Common.questionList.get(9).getFraction()) {
            ...
            String[] questionString = Common.questionList.get(9).getExercise().split("/");
            ...
            tvQuestion2.setText(Common.questionList.get(9).getExercise());
        }

        if(Common.questionList.get(10).getFraction()) {
            ...
            String[] questionString = Common.questionList.get(10).getExercise().split("/");
            ...
            tvQuestion3.setText(Common.questionList.get(10).getExercise());
        }

        if(Common.questionList.get(11).getFraction()) {
            ...
            String[] questionString = Common.questionList.get(11).getExercise().split("/");
            ...
            tvQuestion4.setText(Common.questionList.get(11).getExercise());
        }
    ...
    public void onClick(View v) {
        if(v.getId()==R.id.bnext){
            ...
            if(Common.questionList.get(8).getFraction()) {
                ...
                checkAnswerFraction(Common.questionList.get(8), answer);
            }else{
                if(etAnswer1.getText().toString().equals(Common.questionList.get(8).getAnswerCorrect()))
            ...
            if(Common.questionList.get(9).getFraction()) {
                ...
                checkAnswerFraction(Common.questionList.get(9), answer);
            }else{
                if(etAnswer2.getText().toString().equals(Common.questionList.get(9).getAnswerCorrect()))
                    Common.right_answer_count++;
            }
            ...
            if(Common.questionList.get(10).getFraction()) {
                ...
                checkAnswerFraction(Common.questionList.get(10), answer);
            }else{
                if(etAnswer3.getText().toString().equals(Common.questionList.get(10).getAnswerCorrect()))
                    Common.right_answer_count++;
            }
            if(Common.questionList.get(11).getFraction()) {
                ...
                checkAnswerFraction(Common.questionList.get(11), answer);
            }else{
                if(etAnswer4.getText().toString().equals(Common.questionList.get(11).getAnswerCorrect()))
                    Common.right_answer_count++;
            }
