...
public class Exercise5Activity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(Common.questionList.get(16).getFraction()) {
            ...
            String[] questionString = Common.questionList.get(16).getExercise().split("/");
            ...
            tvQuestion1.setText(Common.questionList.get(16).getExercise());
        }

        if(Common.questionList.get(17).getFraction()) {
            ...
            String[] questionString = Common.questionList.get(17).getExercise().split("/");
            ...
            tvQuestion2.setText(Common.questionList.get(17).getExercise());
        }

        if(Common.questionList.get(18).getFraction()) {
            ...
            String[] questionString = Common.questionList.get(18).getExercise().split("/");
            ...
            tvQuestion3.setText(Common.questionList.get(18).getExercise());
        }

        if(Common.questionList.get(19).getFraction()) {
            ...
            String[] questionString = Common.questionList.get(19).getExercise().split("/");
            ...
            tvQuestion4.setText(Common.questionList.get(19).getExercise());
        }
    ...
    public void onClick(View v) {
        if(v.getId()==R.id.bnext){
            ...
            if(Common.questionList.get(16).getFraction()) {
                ...
                checkAnswerFraction(Common.questionList.get(16), answer);
            }else{
                if(etAnswer1.getText().toString().equals(Common.questionList.get(16).getAnswerCorrect()))
            ...
            if(Common.questionList.get(17).getFraction()) {
                ...
                checkAnswerFraction(Common.questionList.get(17), answer);
            }else{
                if(etAnswer2.getText().toString().equals(Common.questionList.get(17).getAnswerCorrect()))
                    Common.right_answer_count++;
            }
            ...
            if(Common.questionList.get(18).getFraction()) {
                ...
                checkAnswerFraction(Common.questionList.get(18), answer);
            }else{
                if(etAnswer3.getText().toString().equals(Common.questionList.get(18).getAnswerCorrect()))
                    Common.right_answer_count++;
            }
            if(Common.questionList.get(19).getFraction()) {
                ...
                checkAnswerFraction(Common.questionList.get(19), answer);
            }else{
                if(etAnswer4.getText().toString().equals(Common.questionList.get(19).getAnswerCorrect()))
                    Common.right_answer_count++;
            }
